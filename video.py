...
right_eye = cv2.imread('media/left_eye.png')
tongue=cv2.imread('media/tongue.png')
    ...
    if face_mesh_results.multi_face_landmarks:       
        ...
        for face_num, face_landmarks in enumerate(face_mesh_results.multi_face_landmarks):
            ...
            frame = overlay(frame, right_eye, face_landmarks,
                            'NOSE', mp_face_mesh.FACEMESH_RIGHT_EYE, display=False)
          
            if mouth_status[face_num] == 'OPEN':             
                frame = overlay(frame, tongue, face_landmarks, 
